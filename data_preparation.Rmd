...
project$married.or.partner.38 <- factor(microdata$Q38, levels = 1:2, labels = identification)
```

```{r}
project$state <- microdata$`_STATE`
project$years.at.residence <- microdata$Q41
project$years.in.state <- microdata$Q42
```
