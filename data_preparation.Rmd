...
```{r}
microdata$`Month Survey was administered` <- as.character(microdata$`Month Survey was administered`)
microdata$`Month Survey was administered` <- as.Date(as.yearmon(microdata$`Month Survey was administered`, "%Y%m"), frac = 1)
```
